//vamos começar criando algumas funções auxiliares para agilizar o processo de criação dos elementos, já que faremos isso várias vezes
...
function createInput(id, value, name, type = 'text', placeholder = '') {
  ...
  //Vamos criar algumas variáveis globais úteis para a resolução
